...
<head>
	...
	<style>
		...
		:root{
			--albumcover: url(../Images/Thumbnails/bux.webp);
			--phone-bg: #272727;
			--background-alpha: 0; /* Default alpha value, adjust as needed */
			--background-rgb: 105, 0, 255; /* Default RGB values, adjust as needed */
			--projectbacker: black;
...
.split{
    ...
    max-width:100%;
	  ...
	  <script>
		...
		elements.forEach(function(element) {
			element.innerHTML = 'Buxton Contemporary';
 		 });
		});
    ...
    if (projectElement) {
		...
		elements.forEach(function(element) {
			element.innerHTML = 'Rishab Kiran, Ronald Liao, Xinyu Choot';
 		 });
		});
	...
	<?php include 'sidebarp.php'; ?>
		...
		<section class="home-page">
			...
			<div class="custom-scroll" onscroll="updateProgressBar()">
					...
					<div class="intro" style="  z-index: 100; color: black!important; background-color: white;">
						<div class="overview">
							...
							<p style="color: black!important;">
								...
								In the exploration of a visual rebranding for Buxton Contemporary, a prominent public art museum located at the University of Melbourne's Southbank Campus, the project focused on enhancing wayfinding elements. The initiative included the creation of a distinct logo, along with the development of maps, pictograms, and signage geared towards improving visitor navigation within the museum. Within the team, my primary role involved crafting pictograms and designing 3D maps, contributing to the creation of a cohesive and user-friendly visual system for Buxton Contemporary. While this project is hypothetical, it provided valuable experience in conceptualizing and executing design solutions tailored to real-world environments.
							</p>
						</div>
						<div  class="tools">
				...
				<img width="100%" class="fade" src="../Images/bux/bux.webp" alt=""  loading="lazy">
				<img width="100%"  src="../Images/bux/buxlong1.jpg" alt=""  loading="lazy">
				<img width="100%"  src="../Images/bux/buxlong.jpg" alt="" loading="lazy">
				<img width="100%"   src="../Images/bux/buxlong4.jpg" alt="" loading="lazy">
