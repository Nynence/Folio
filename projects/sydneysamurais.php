...
<head>
	...
	<style>
		...
		:root{
			--albumcover: url(../Images/Thumbnails/sydney.webp);
			--phone-bg: #272727;
    ...
    max-width:100%;
	  ...
	  <script>
		...
		elements.forEach(function(element) {
			element.innerHTML = 'Sydney Samurais';
 		 });
		});
				...
				<div class="projects" style="padding-bottom: 50px; background-color: ;">
					...
					<div class="intro" style="  z-index: 100">
						<div class="overview">
							<h8>Overview</h8>
							<p>
								The Sydney Samurais project was an ambitious undertaking focused on creating a comprehensive brand identity for a fictional esports team. Spanning from initial surveys and in-depth research to final conceptual development, this project encompassed various aspects of communication and industrial design. The final outcomes was a strong visual identity and a custom-made gaming headset to support the brands presence. This project was culmination of my Year 12 VCE visual communication studies and was selected for the 2021 Top Designs, showcased at the Melbourne Museum.
								<br><br>
								The complete project PDF can be accessed here: <a target=”_blank” class="linkclass" style="text-decoration: none; cursor: none ; text-decoration: underline;" href="https://drive.google.com/file/d/1VkyPvcbT10d2oXzF2LikuNVhpCEL5KeG/view?usp=sharing">Sydney Samurais.pdf</a>
							</p>
						</div>
						<div class="tools">
							<h8>Tools</h8>
					...
					<img class="zoomD" src="../Images/ss/brief.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/ss/branding.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/ss/branding2.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/ss/branding3.webp" alt="" loading="lazy">
					<img class="zoomD" style="" src="../Images/ss/ortho.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/ss/46850573W_Kiran_Project 3.webp" alt="" loading="lazy">
