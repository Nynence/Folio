<div class="sidebar" id="sidebar">
			...
			<div class="navigation">
					<ul class="navpadding">
						...
						<a href="../index.html" style="cursor: none;">
			...
			<div class="bottomnav">
				...
				<div class="metext">
					...
					<p id="p"  class="typewriter">
						A UI/UX & Graphic Designer driven by the pursuit of creating impactful experiences through diverse mediums.
						<br><br>
						Beyond design, you'll find me on the tennis court, drumming to unwind, and recently venturing into 3D printing.
						<br><br>


						I graduated from the The University of Melbourne, with a degree in User Experience and Graphic Design.
						<br><br>

						I'm always keen for exciting projects. Feel free to connect with me on any of my socials below.
					
					<br><br>
					<div class="social-links">
						<a href="mailto:rishabkiran.creative@gmail.com" target="_blank" class="social-link email">Email</a>
						<a href="https:/www.linkedin.com/in/rishab-kiran" target="_blank" class="social-link linkedin">LinkedIn</a>
						<a href="https://www.instagram.com/rishcreative/" target="_blank" class="social-link instagram">Instagram</a>
					</div>
