...
<head>
	...
	<style>
		...
		:root{
			--albumcover: url(../Images/Thumbnails/vsi.webp);
			--phone-bg: #272727;
			--background-alpha: 0; /* Default alpha value, adjust as needed */
			--background-rgb: 80, 40, 173; /* Default RGB values, adjust as needed */
			--projectbacker: black;
    ...
    max-width:100%;
	  ...
	  <script>
		...
		elements.forEach(function(element) {
			element.innerHTML = 'Very Short Introductions';
 		 });
		});
			...
			<div class="custom-scroll" onscroll="updateProgressBar()">
				...
				<div class="projects" style="padding-bottom: 50px; background-color: ;">
					...
					<div class="intro" style=";  z-index: 100">
						<div class="overview">
							<h8>Overview</h8>
							<p>This project embarked on a comprehensive redesign of the book covers for the Oxford Series "Very Short Introductions." Beginning with thorough research into the series' target audience, content, and visual identity, I delved into exploring various design concepts, typography, and imagery to encapsulate the essence of each subject. Employing a meticulous process, I iteratively refined my designs, incorporating feedback and ensuring coherence across the entire series. From initial sketches to final renders, my approach integrated both aesthetic appeal and functional clarity, aiming to enhance the series' shelf presence and reader engagement in the realm of publication print media.
							</p>
						</div>
						<div class="tools">
							<h8>Tools</h8>
					...
					<img class="zoomD" src="../Images/vsi/1.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/12.webp" alt=""  loading="lazy">
					<img class="zoomD" src="../Images/vsi/13.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/14.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/15.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/16.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/17.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/18.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/19.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/110.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/111.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/112.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/113.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/114.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/115.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/116.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/117.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/118.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/119.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/120.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/121.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/122.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/123.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/124.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/125.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/126.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/127.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/128.webp" alt=""  loading="lazy">
					<img class="zoomD" src="../Images/vsi/129.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/130.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/131.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/132.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/133.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/134.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/135.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/136.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/137.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/138.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/139.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/140.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/141.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits.webp" alt=""  loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits2.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits3.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits4.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits5.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits6.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits7.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits8.webp" alt="" loading="lazy">
					<img class="zoomD" src="../Images/vsi/Book Final Edits9.webp" alt="" loading="lazy">




					<img class="zoomD"  src="../Images/vsi/142.webp" alt=""  loading="lazy">
