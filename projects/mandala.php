...
<head>
	...
	<style>
		...
		:root{
			--albumcover: url(../Images/Thumbnails/man.webp);
			--phone-bg: #272727;
			--background-alpha: 0; /* Default alpha value, adjust as needed */
			--background-rgb: 0, 0, 204; /* Default RGB values, adjust as needed */
			--projectbacker: black;
...
.split{
    ...
    max-width:100%;
	  ...
	  <script>
		...
		elements.forEach(function(element) {
			element.innerHTML = 'The Mandala Journal';
 		 });
		});
...
<!-- <div id="loading-screen">
			...
			<div class="custom-scroll" onscroll="updateProgressBar()">
				...
				<div class="projects" style="padding-bottom: 50px; background-color: ;">
					...
					<div class="intro" style="  z-index: 100; color: black!important; background-color: rgb(0, 0, 0);">
						...
						For my final self-directed university project, I embarked on a journey to showcase a culmination of my diverse skill set. Inspired by a desire to seamlessly integrate physical and digital mediums, I ventured into the realm of augmented reality. The project centered around the exploration of mandalas, serving as a conduit for spiritual connection and an avenue to illuminate the beauty of this ancient art form in a captivating and mesmerizing manner. Through a fusion of traditional and modern techniques, I aimed to create an immersive experience that transcended conventional boundaries, inviting viewers to delve into a world where art and technology harmonise seamlessly.


								<br><br>
						The website experience can be accessed from here:<a target=”_blank” class="linkclass" style="
						text-decoration: none; cursor: none ; text-decoration: underline;" href="https://rishabkrn.wixsite.com/the-mandala-journal">The Mandala Journal</a>
  ...
  .video-container video {
    ...
    height: auto;
								...
								<img class="zoomD" src="../Images/man/cover.webp" alt=""  loading="lazy">
...
// });
				...
				<img class="zoomD" src="../Images/man/man2.webp" alt=""  loading="lazy">
				<img class="zoomD" src="../Images/man/man3.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man4.webp" alt="" loading="lazy">
				<img class="zoomD"  src="../Images/man/man5.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man6.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man7.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man8.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man9.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man10.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man11.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man12.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man13.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man14.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man15.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man16.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man17.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man18.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man19.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man20.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man21.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man22.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man23.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man24.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man25.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man26.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man27.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man28.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man29.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man30.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man31.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man32.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man33.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man34.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man35.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man36.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man37.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man38.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man39.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man40.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man41.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man42.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man43.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man44.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man45.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man46.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man47.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man48.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man49.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man50.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man51.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man52.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man53.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man54.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man55.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man56.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man57.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man58.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man59.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man60.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man61.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man62.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man63.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man64.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man65.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man66.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man67.webp" alt="" loading="lazy">
				<img class="zoomD" src="../Images/man/man68.webp" alt="" loading="lazy">
